		...
		<div class="am-cf admin-main">
			...
			<div class="admin-content">
				...
				<div class="am-cf am-padding">
					<div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">添加岗位</strong> <small></small></div>
				</div>
				...
				<div class="am-tabs am-margin " data-am-tabs>
					...
					<div class="am-tabs-bd">
						<div class="am-tab-panel am-fade am-in am-active" id="tab1" style="margin-left: 80px; background-image: url(<%=path %>/jsp/assets/i/addbackground.png);">
							...
							<form action="<%=path %>/post/addPost.action" method="post" class="am-form am-form-inline" onsubmit="return validate();">
								<!--岗位名称-->
								<div class="am-g am-margin-top">
									...
									<div class="am-u-sm-10">
										<div class="am-form-group ">
											<input style="width: 178px;" type="text" class="am-form-field am-input-sm" name="post_name" required="required">
										</div>
									</div>
								</div>
								...
								<div class="am-g am-margin-top">
									...
									<div class="am-u-sm-10">
										<div class="am-form-group ">
											<input style="width: 178px;" type="text" class="am-form-field am-input-sm" name="strength" id="strength" required="required">
										</div>
									</div>
								</div>
