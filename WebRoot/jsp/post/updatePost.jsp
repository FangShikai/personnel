		...
		<div class="am-cf admin-main">
			...
			<div class="admin-content">
				...
				<div class="am-cf am-padding">
					<div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">修改岗位</strong> <small></small></div>
				</div>
				...
				<div class="am-tabs am-margin " data-am-tabs>
					...
					<div class="am-tabs-bd">
						<div class="am-tab-panel am-fade am-in am-active" id="tab1" style="margin-left: 80px; background-image: url(<%=path%>/jsp/assets/i/addbackground.png);">
							...
							<form action="<%=path %>/post/updatePost.action" method="post" class="am-form am-form-inline" onsubmit="return validate();">
								<!--岗位ID-->
								<div class="am-g am-margin-top">
									...
									<div class="am-u-sm-10">
										<div class="am-form-group ">
											<input style="width: 178px;" type="text" class="am-form-field am-input-sm" name="post_id" value=${pos.post_id } readonly="true">
										</div>
									</div>
								</div>
								...
								<div class="am-g am-margin-top">
									...
									<div class="am-u-sm-10">
										<div class="am-form-group ">
											<input style="width: 178px;" type="text" class="am-form-field am-input-sm" name="post_name" value="${pos.post_name }" required="required">
										</div>
									</div>
								</div>
								...
								<div class="am-g am-margin-top">
									...
									<div class="am-u-sm-10">
										<select style="width: 178px;" name="post_type">
											<option value="1" ${pos.post_type=='1' ? 'selected': '' }>管理</option>
											<option value="2" ${pos.post_type=='2' ? 'selected': '' }>技术</option>
											<option value="3" ${pos.post_type=='3' ? 'selected': '' }>营销</option>
											<option value="4" ${pos.post_type=='4' ? 'selected': '' }>市场</option>
										</select>
									</div>
								</div>
								...
								<div class="am-g am-margin-top">
									...
									<div class="am-u-sm-10">
										<div class="am-form-group ">
											<input style="width: 178px;" type="text" class="am-form-field am-input-sm" name="strength" id="strength" value="${pos.strength }" required="required">
										</div>
									</div>
								</div>
