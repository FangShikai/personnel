		...
		<div class="am-cf admin-main">
			...
			<div class="admin-content">
				...
				<div class="am-cf am-padding">
					<div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">部门调动报表</strong> <small></small></div>
				</div>
					...
					<div class="am-u-sm-12">
						<form class="am-form">
							<table class="am-table am-table-striped am-table-hover table-main">
								...
								<c:forEach items="${allDep_trans}" var="dep_trans" varStatus="i">
									<tr>
										<td>${i.index+1 }</td>
										<td>${dep_trans.employee.department.dep_id } </td>
										<td>${dep_trans.employee.emp_name }</td>
										<td>
											<c:if test="${dep_trans.employee.emp_sex=='1' }">男</c:if>
											<c:if test="${dep_trans.employee.emp_sex=='2' }">女</c:if>
										</td>
										<td> ${dep_trans.employee.post.post_name } </td>
										<td>${dep_trans.department.dep_name } </td>
										<td>
											<fmt:formatDate value="${dep_trans.trans_date }" pattern="yyyy-MM-dd" />
										</td>
										<td>
											${dep_trans.trans_reason}
										</td>
									</tr>
								</c:forEach>
