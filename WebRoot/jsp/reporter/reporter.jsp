		...
		<div class="am-cf admin-main">
			...
			<div class="admin-content">
				...
				<div class="am-cf am-padding">
					<div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">报表查询</strong> <small></small></div>
				</div>
				...
				<div class="am-tabs am-margin " data-am-tabs>
					...
					<div class="am-tabs-bd">
						<div class="am-tab-panel am-fade am-in am-active" id="tab1" style="margin-left: 80px; background-image: url(<%=path %>/jsp/assets/i/addbackground.png);">
							...
							<form action="<%=path %>/reporter/judgeReporter.action" method="post" class="am-form am-form-inline" id="frm1">
								...
								<div class="am-g am-margin-top">
									...
									<div class="am-u-sm-10">
										<div class="am-form-group am-form-icon">
											...
											<input type="date" class="am-form-field am-input-sm" name="begin_date" id="d1" required="required">
										</div>
									</div>
								</div>
								...
								<div class="am-margin" style="margin-left: 100px;">
									<button type="submit" class="am-btn am-btn-primary am-btn-xs" value="新聘员工报表" name="action">新聘员工报表</button>
									<button type="submit" class="am-btn am-btn-primary am-btn-xs" value="离职员工报表" name="action">离职员工报表</button>
									<button type="submit" class="am-btn am-btn-primary am-btn-xs" value="部门调动员工报表" name="action">部门调动报表</button>
									<button type="submit" class="am-btn am-btn-primary am-btn-xs" value="岗位调动员工报表" name="action">岗位调动报表</button>
