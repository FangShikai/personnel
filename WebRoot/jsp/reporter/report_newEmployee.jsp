 ...
 <div class="am-collapse am-topbar-collapse" id="topbar-collapse">
  ...
  <div class="admin-content">
    ...
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">新聘员工报表</strong> <small></small></div>
    </div>
      ...
      <div class="am-u-sm-12">
        <form class="am-form">
          <table class="am-table am-table-striped am-table-hover table-main">
              ...
              <th class="table-title">姓名</th><th class="table-type">性别</th>
                <th class="table-date">所在部门</th><th class="table-set">岗位</th>
              <th class="table-author">入职日期</th>
              </tr>
        
          <c:forEach items="${allEmployee }" var="employee" varStatus="i">
    		<tr>
    			<td>${i.index+1 }</td>
