		...
		<div class="am-cf admin-main">
			...
			<div class="admin-content">
				...
				<div class="am-cf am-padding">
					<div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">添加部门</strong> <small></small></div>
				</div>
				...
				<div class="am-tabs am-margin " data-am-tabs>
					...
					<div class="am-tabs-bd">
						<div class="am-tab-panel am-fade am-in am-active" id="tab1" style="margin-left: 80px; background-image: url(<%=path %>/jsp/assets/i/addbackground.png);">
							...
							<form action="<%=path %>/department/addDepartment.action" method="post" class="am-form am-form-inline" id="frm1">
								<!--部门名称-->
								<div class="am-g am-margin-top">
									...
									<div class="am-u-sm-10">
										<div class="am-form-group ">
											<input style="width: 178px;" type="text" class="am-form-field am-input-sm" name="dep_name" required="required">
										</div>
									</div>
								</div>
								...
								<div class="am-g am-margin-top">
									...
									<div class="am-u-sm-10">
										<div class="am-form-group ">
											<input style="width: 178px;" type="text" class="am-form-field am-input-sm" name="dep_phone" required="required">
										</div>
									</div>
								</div>
								...
								<div class="am-g am-margin-top">
									...
									<div class="am-u-sm-10">
										<div class="am-form-group ">
											<input style="width: 178px;" type="text" class="am-form-field am-input-sm" name="dep_far">
										</div>
									</div>
								</div>
								...
								<div class="am-g am-margin-top">
									...
									<div class="am-u-sm-10">
										<div class="am-form-group ">
											<input style="width: 178px;" type="text" class="am-form-field am-input-sm" name="dep_describe">
										</div>
									</div>
								</div>
								...
								<div class="am-g am-margin-top">
									...
									<div class="am-u-sm-10">
										<div class="am-form-group am-form-icon">
											...
											<input type="date" class="am-form-field am-input-sm" name="estdate" id="d1" required="required">
										</div>
									</div>
								</div>
