		...
		<div class="am-cf admin-main">
			...
			<div class="admin-content">
				...
				<div class="am-cf am-padding">
					<div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">修改岗位调转</strong> <small></small></div>
				</div>
				...
				<div class="am-tabs am-margin " data-am-tabs>
					...
					<div class="am-tabs-bd">
						<div class="am-tab-panel am-fade am-in am-active" id="tab1" style="margin-left: 80px; background-image: url(<%=path%>/jsp/assets/i/addbackground.png);">
							...
							<form action="<%=path %>/post_trans/updatePost_trans.action" method="post" class="am-form am-form-inline">
								<!--调转信息编号-->
								<div class="am-g am-margin-top">
									...
									<div class="am-u-sm-10">
										<div class="am-form-group ">
											<input style="width: 178px;" type="text" class="am-form-field am-input-sm" name="post_trans_id" value="${allPost_trans.post_trans_id }" readonly="true">
										</div>
									</div>
								</div>
								...
								<div class="am-g am-margin-top">
									...
									<div class="am-u-sm-10">
										<div class="am-form-group ">
											<input style="width: 178px;" type="text" class="am-form-field am-input-sm" name="employee.emp_id" value="${allPost_trans.employee.emp_id }" readonly="true">
										</div>
									</div>
								</div>
									...
									<div class="am-u-sm-10">
										<select style="width: 178px;" name="post.post_id">
											<c:forEach items="${allPost }" var="post">
												<option value="${post.post_id}" ${allPost_trans.post.post_id==post.post_id ? 'selected': '' }>${post.post_name}</option>
											</c:forEach>
										</select>
									</div>
								</div>
								...
								<div class="am-g am-margin-top">
									...
									<div class="am-u-sm-10">
										<select style="width: 178px;" name="trans_type">
											<option value="1" ${allPost_trans.trans_type=='1' ? 'selected': '' }>升职</option>
											<option value="2" ${allPost_trans.trans_type=='2' ? 'selected': '' }>降职</option>
											<option value="3" ${allPost_trans.trans_type=='3' ? 'selected': '' }>数据录入错误</option>
										</select>
									</div>
								</div>
								...
								<div class="am-g am-margin-top">
									...
									<div class="am-u-sm-10">
										<div class="am-form-group ">
											<input style="width: 178px;" type="text" class="am-form-field am-input-sm" name="trans_reason" value="${allPost_trans.trans_reason }" required="required">
										</div>
									</div>
								</div>
								...
								<div class="am-g am-margin-top">
									...
									<div class="am-u-sm-10">
										<div class="am-form-group ">
											<input style="width: 178px;" type="text" class="am-form-field am-input-sm" name="note" value="${allPost_trans.note }">
										</div>
									</div>
								</div>
								...
								<div class="am-g am-margin-top">
									...
									<div class="am-u-sm-10">
										<div class="am-form-group am-form-icon">
											...
											<input type="date" class="am-form-field am-input-sm" name="trans_date" value="<fmt:formatDate value='${allPost_trans.trans_date }' pattern='yyyy-MM-dd'/>" required="required">
										</div>
									</div>
								</div>
