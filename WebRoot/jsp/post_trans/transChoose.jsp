		...
		<div class="am-cf admin-main">
			...
			<div class="admin-content">
				...
				<div class="am-cf am-padding">
					<div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">岗位调转类别</strong> <small></small></div>
				</div>
              ...
              <button type="button" class="am-btn am-btn-default" onclick="window.location.href='<%=path %>/dep_trans/selectAllEmployee.action'" ><span class="am-icon-plus"></span> 准备调转信息管理</button>
             
            </div>
            
            <div class="am-btn-group am-btn-group-xs">
              <button type="button" class="am-btn am-btn-default" onclick="window.location.href='<%=path %>/dep_trans/selectAllDep_trans.action'" ><span class="am-icon-plus"></span> 已调转信息管理</button>
             
            </div>-->

								<form action="<%=path %>/post_trans/selectSomeEmployee.action" method="post">
				  	...
				  	<input class="am-btn am-btn-default" type="submit" value="准备调转信息管理">
								...
								<form action="<%=path %>/post_trans/selectAllPost_trans.action" method="post">
									<span class="am-input-group-btn">
