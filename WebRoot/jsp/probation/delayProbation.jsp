		...
		<div class="am-cf admin-main">
			...
			<div class="admin-content">
				...
				<div class="am-cf am-padding">
					<div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">试用期延期</strong> <small></small></div>
				</div>
				...
				<div class="am-tabs am-margin " data-am-tabs>
					...
					<div class="am-tabs-bd">
						<div class="am-tab-panel am-fade am-in am-active" id="tab1" style="margin-left: 80px; background-image: url(<%=path%>/jsp/assets/i/addbackground.png);">
							...
							<form action="<%=path%>/probation/updateProbationDateByID.action" method="post" class="am-form am-form-inline" >
								<!--员工ID-->
								<div class="am-g am-margin-top">
									
									<div class="am-u-sm-10">
										<div class="am-form-group ">
											<input style="width: 178px;" type="hidden" class="am-form-field am-input-sm" name=pro_id value="${probation.pro_id}" readonly="true">
										</div>
									</div>
								</div>
								...
								<div class="am-g am-margin-top">
									...
									<div class="am-u-sm-10">
										<div class="am-form-group am-form-icon">
											...
											<input type="date" class="am-form-field am-input-sm" name="end_date"  value="<fmt:formatDate value='${probation.end_date }' pattern='yyyy-MM-dd'/>"  
											min="<fmt:formatDate value='${probation.end_date }' pattern='yyyy-MM-dd'/>">
										</div>
									</div>
								</div>
