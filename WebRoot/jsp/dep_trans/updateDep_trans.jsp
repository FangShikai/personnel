		...
		<div class="am-cf admin-main">
			...
			<div class="admin-content">
				...
				<div class="am-cf am-padding">
					<div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">修改部门调转</strong> <small></small></div>
				</div>
				...
				<div class="am-tabs am-margin " data-am-tabs>
					...
					<div class="am-tabs-bd">
						<div class="am-tab-panel am-fade am-in am-active" id="tab1" style="margin-left: 80px; background-image: url(<%=path%>/jsp/assets/i/addbackground.png);">
							...
							<form action="<%=path %>/dep_trans/updateDep_trans.action" method="post" class="am-form am-form-inline">
								<!--调转信息编号-->
								<div class="am-g am-margin-top">
									...
									<div class="am-u-sm-10">
										<div class="am-form-group ">
											<input style="width: 178px;" type="text" class="am-form-field am-input-sm" name="dep_trans_id" value="${Dep_trans_update_before.dep_trans_id}" readonly="true">
										</div>
									</div>
								</div>
								...
								<div class="am-g am-margin-top">
									...
									<div class="am-u-sm-10">
										<div class="am-form-group ">
											<input style="width: 178px;" type="text" class="am-form-field am-input-sm" name="employee.emp_id" value="${Dep_trans_update_before.employee.emp_id}" readonly="true">
										</div>
									</div>
								</div>
								...
								<!--调转后的部门-->
								<div class="am-g am-margin-top">
									<div class="am-u-sm-2 am-text-right">调转后的部门</div>
									<div class="am-u-sm-10">
										<select style="width: 178px;" name="department.dep_id">
											<c:forEach items="${allDepartment }" var="department">
												<option value="${department.dep_id}" ${Dep_trans_update_before.department.dep_id==department.dep_id ? 'selected': '' }>${department.dep_name}</option>
											</c:forEach>
										</select>
									</div>
								</div>
								...
								<div class="am-g am-margin-top">
									...
									<div class="am-u-sm-10">
										<select style="width: 178px;" name="trans_type">
											<option value="1" ${Dep_trans_update_before.trans_type=='1' ? 'selected': '' }>主动调动</option>
											<option value="2" ${Dep_trans_update_before.trans_type=='2' ? 'selected': '' }>被动调动</option>
											<option value="3" ${Dep_trans_update_before.trans_type=='3' ? 'selected': '' }>数据错误</option>
										</select>
									</div>
								</div>
								...
								<div class="am-g am-margin-top">
									...
									<div class="am-u-sm-10">
										<div class="am-form-group ">
											<input style="width: 178px;" type="text" class="am-form-field am-input-sm" name="trans_reason" value="${Dep_trans_update_before.trans_reason}" required="required">
										</div>
									</div>
								</div>
								...
								<div class="am-g am-margin-top">
									...
									<div class="am-u-sm-10">
										<div class="am-form-group ">
											<input style="width: 178px;" type="text" class="am-form-field am-input-sm" name="note" value="${Dep_trans_update_before.note}">
										</div>
									</div>
								</div>
								...
								<div class="am-g am-margin-top">
									...
									<div class="am-u-sm-10">
										<div class="am-form-group am-form-icon">
											...
											<input type="date" class="am-form-field am-input-sm" name="trans_date" value="<fmt:formatDate value='${Dep_trans_update_before.trans_date }' pattern='yyyy-MM-dd'/>" required="required">
										</div>
									</div>
								</div>
