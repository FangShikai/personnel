...
<html>
	...
	-->
		...
		<script type="text/javascript">
			function dep_trans(emp_id) {
				if(confirm("是否进行该员工的部门调动？")) {
					location.href = "<%=path%>/dep_trans/selectNowDepartmentById.action?emp_id=" + emp_id;
				}
			}
		...
		<div class="am-cf admin-main">
			...
			<div class="admin-content">
				...
				<div class="am-cf am-padding">
					<div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">准备调转基本信息</strong> <small></small></div>
				</div>

				<div class="am-g" style="margin-left:850px">
					...
					<div class="am-u-md-3 am-cf">
						<div class="am-fr">
							...
							<div class="am-input-group am-input-group-sm" >
								...
								<form action="<%=path %>/dep_trans/selectEmployeeById.action" method="post" onsubmit="return validate();">
										...
										<td>
											<div class="am-btn-toolbar">
												<div class="am-btn-group am-btn-group-xs">
													<button type="button" class="am-btn am-btn-default am-btn-xs am-text-secondary" onclick="window.location.href='javascript:dep_trans(${employee.emp_id})'"><span class="am-icon-pencil-square-o"></span>调动</button>
												</div>
											</div>
										</td>
									</tr>
