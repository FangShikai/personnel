				...
				<div class="am-tabs am-margin " data-am-tabs>
					...
					<div class="am-tabs-bd">
						<div class="am-tab-panel am-fade am-in am-active" id="tab1" style="margin-left: 80px; background-image: url(<%=path%>/jsp/assets/i/addbackground.png);">
							...
							<form action="<%=path %>/dep_trans/addDep_trans.action" method="post" class="am-form am-form-inline">
								...
								<div class="am-g am-margin-top">
									...
									<div class="am-u-sm-10">
										<div class="am-form-group ">
											<input style="width: 178px;" type="text" class="am-form-field am-input-sm" name="employee.emp_id" value="${Dep_transList.emp_id }" readonly="true">
										</div>
									</div>
								</div>
									...
									<div class="am-u-sm-10">
										<select style="width: 178px;" name="department.dep_id">
											<c:forEach items="${allDepartment }" var="department">
												<option value="${department.dep_id}" ${Dep_transList.department.dep_id==department.dep_id ? 'selected': '' }>${department.dep_name}</option>
											</c:forEach>
										</select>
									</div>
								</div>
								...
								<div class="am-g am-margin-top">
									...
									<div class="am-u-sm-10">
										<select style="width: 178px;" name="trans_type">
											<option value="1">主动调动</option>
											<option value="2">被动调动</option>
											<option value="3">数据错误</option>
										</select>
									</div>
								</div>
