		...
		<div class="am-cf admin-main">
			...
			<div class="admin-content">
				...
				<div class="am-cf am-padding">
					<div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">修改离职信息</strong> <small></small></div>
				</div>
				...
				<div class="am-tabs am-margin " data-am-tabs>
					...
					<div class="am-tabs-bd">
						<div class="am-tab-panel am-fade am-in am-active" id="tab1" style="margin-left: 80px; background-image: url(<%=path%>/jsp/assets/i/addbackground.png);">
							...
							<form action="<%=path %>/dimission/updateDimission.action" method="post" class="am-form am-form-inline">
								...
								<div class="am-g am-margin-top">
									...
									<div class="am-u-sm-10">
										<div class="am-form-group ">
											<input style="width: 178px;" type="hidden" class="am-form-field am-input-sm" name="dim_id" value="${dimission.dim_id }" readonly="true">
										</div>
									</div>
								</div>
								<!--员工ID-->
								<div class="am-g am-margin-top">
									...
									<div class="am-u-sm-10">
										<div class="am-form-group ">
											<input style="width: 178px;" type="hidden" class="am-form-field am-input-sm" name="employee.emp_id" value="${dimission.employee.emp_id }" readonly="true">
										</div>
									</div>
								</div>
								...
								<div class="am-g am-margin-top">
									...
									<div class="am-u-sm-10">
										<div class="am-form-group am-form-icon">
											...
											<input type="date" class="am-form-field am-input-sm" name="dim_date" value="<fmt:formatDate value='${dimission.dim_date }' pattern='yyyy-MM-dd'/>" required="required">
										</div>
									</div>
								</div>
								...
								<!--离职类型-->
								<div class="am-g am-margin-top">
									<div class="am-u-sm-2 am-text-right">离职类型</div>
									<div class="am-u-sm-10">
										<select style="width: 178px;" name="dim_type">
											<option value="1" ${dimission.dim_type=='1' ? 'selected': '' }>主动辞职</option>
											<option value="2" ${dimission.dim_type=='2' ? 'selected': '' }>辞退</option>
											<option value="3" ${dimission.dim_type=='3' ? 'selected': '' }>退休</option>
											<option value="4" ${dimission.dim_type=='4' ? 'selected': '' }>开除</option>
											<option value="5" ${dimission.dim_type=='5' ? 'selected': '' }>试用期未通过</option>
								...
								<div class="am-g am-margin-top">
									...
									<div class="am-u-sm-10">
										<div class="am-form-group ">
											<input style="width: 178px;" type="text" class="am-form-field am-input-sm" name="dim_direc" value="${dimission.dim_direc }">
										</div>
									</div>
								</div>
								...
								<div class="am-g am-margin-top">
									...
									<div class="am-u-sm-10">
										<div class="am-form-group ">
											<input style="width: 178px;" type="text" class="am-form-field am-input-sm" name="note" value="${dimission.note }">
										</div>
									</div>
								</div>
