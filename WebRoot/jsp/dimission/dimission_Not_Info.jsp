		...
		<div class="am-cf admin-main">
			...
			<div class="admin-content">
				...
				<div class="am-cf am-padding">
					<div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">在职员工离职管理</strong> <small></small></div>
				</div>
					...
					<div class="am-u-md-3 am-cf">
						<div class="am-fr">
							...
							<div class="am-input-group am-input-group-sm">
								...
								<form action="<%=path %>/dimission/selectAllDimission.action" method="post">
									<span class="am-input-group-btn">
				  	<input class="am-btn am-btn-default" type="submit" value="查询离职员工">
				  	 </span>
								</form>

								<form action="<%=path %>/dimission/selectDimission_not_ById.action" method="post" onsubmit="return validate();">
									<span class="am-input-group-btn">
							...
							<table class="am-table am-table-striped am-table-hover table-main">
								...
								<c:forEach items="${allEmployee }" var="employee">
									<tr>
										...
										<td>
											<c:if test="${employee.emp_sex=='1' }">男</c:if>
											<c:if test="${employee.emp_sex=='2' }">女</c:if>
										</td>
										<td>
										...
										<td>
											<fmt:formatDate value="${employee.entry_date  }" pattern="yyyy-MM-dd" />
										</td>
										<td>
											<fmt:formatDate value="${employee.work_date }" pattern="yyyy-MM-dd" />
										</td>
										<td>
										...
										<td>
											<div class="am-btn-toolbar">
												<div class="am-btn-group am-btn-group-xs">
													<button type="button" class="am-btn am-btn-default am-btn-xs am-text-secondary" onclick="window.location.href='<%=path %>/dimission/transAddDimission.action?id=${employee.emp_id }'"><span class="am-icon-pencil-square-o"></span>离职</button>
												</div>
											</div>
										</td>
									</tr>
